...
export default function Published({ posts }: { posts: Draft[] }) {
    
    const handleDelete = (slug: string) => {
        if (confirm('Are you sure you want to delete this published post? This cannot be undone.')) {
            ...
            <div className="w-[90%] mx-auto p-4 md:p-6 lg:p-8">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                    <div>
                        ...
                        <p className="text-gray-500 mt-2 font-medium ml-1">
                            Manage your published posts and articles.
                        </p>
                    </div>
                ...
                {posts.length > 0 ? (
                            ...
                            >
                                ...
                                <div className="p-6 flex flex-col flex-grow">
                                    ...
                                    <div className="flex items-center gap-2 text-[10px] font-bold text-gray-400 mb-3 uppercase tracking-widest">
                                        ...
                                        <span>Saved {new Date(post.updated_at).toLocaleDateString('en-US', { month: 'short', day: 'numeric', hour: '2-digit', minute:'2-digit' })}</span>
                                    </div>
                                    ...
                                    <h3 className="text-lg font-extrabold text-gray-900 mb-3 leading-tight group-hover:text-[#37368b] transition-colors line-clamp-2">
                                        {post.title || <span className="italic text-gray-400">Untitled Post</span>}
                                    </h3>
                    ...
                    <div className="flex flex-col items-center justify-center py-24 bg-white rounded-[2rem] border-2 border-dashed border-gray-200">
                        ...
                        <h3 className="text-xl font-bold text-gray-900">No published posts found</h3>
                        <p className="text-gray-500 max-w-sm text-center mt-2 font-medium">
                            You don't have any published posts right now.
                        </p>
                        <Link 
                            href="/blog/create" 
